...
init_velo = [0.5 1.2 1.9 2.6 3.3];
init_orie = 0.38;
init_phi = 0;
init_dphi = 0;
init_state = [init_velo(1);init_orie;init_phi;init_dphi];
% initial trajectory
...
%% 2
init_state = [init_velo(2);init_orie;init_phi;init_dphi];
% initial trajectory
current_traj = [traj_x; traj_y; zeros(4,N)];
current_input = zeros(2,N);
dt = time_step;
...
%% 3
init_state = [init_velo(3);init_orie;init_phi;init_dphi];
% initial trajectory
current_traj = [traj_x; traj_y; zeros(4,N)];
current_input = zeros(2,N);
dt = time_step;
...
%% 4
init_state = [init_velo(4);init_orie;init_phi;init_dphi];
% initial trajectory
current_traj = [traj_x; traj_y; zeros(4,N)];
current_input = zeros(2,N);
dt = time_step;
